...
from structural_descriptors_repo.connectivity_from_structure import get_connectivity_matrix, Polyhedra
from structural_descriptors_repo.effective_coordination import EffectiveCoordFinder
import unittest
...
class TestVariousStructures(unittest.TestCase):
    ...
    def test_barite(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(barite_structure, False, 3.0, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Ba']['S'].keys():
            self.assertEqual(connectivity_matrix['Ba']['S'][connectivity_type]*barite_structure.composition['Ba'],
                             ...
                             "Total number of sharing instances between 'Ba' and 'S' should be same as total number of sharing"
    ...
    def test_k2so4(self):
        ...
        for cation in CNs:
            self.assertTrue(cation == "K" or cation == "S", "Ba and SO4 polyanions should be the only ions in beta-K2SO4")
            if cation == 'K':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(k2so4_structure, False, 3.2, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['K']['S'].keys():
            self.assertEqual(connectivity_matrix['K']['S'][connectivity_type]*k2so4_structure.composition['K'],
                             ...
                             "Total number of sharing instances between 'K' and 'S' should be same as total number of sharing"
    ...
    def test_fluorite(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(caf2_structure, False, 2.6, peripheral_species, central_species)
    ...
    def test_cafe2o4(self):
        ...
        for cation in CNs:
            self.assertTrue(cation == "Ca" or cation == "Fe", "Ca and Fe should be the only cations in CaFe2O4 structure")
            if cation == 'Ca':
                self.assertLessEqual(round(CNs[cation]), 8, "Ca should be 8-fold coordinated (effective coordination underestimates)")
            if cation == 'Fe':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(cafe2o4_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Ca']['Fe'].keys():
            self.assertEqual(connectivity_matrix['Ca']['Fe'][connectivity_type]*cafe2o4_structure.composition['Ca'],
                             ...
                             "Total number of sharing instances between 'Ca' and 'Fe' should be same as total number of sharing"
    ...
    def test_calcite(self):
        ...
        for cation in CNs:
            self.assertTrue(cation == "Ca" or cation == "C", "Ba and SO4 polyanions should be the only ions in beta-K2SO4")
            if cation == 'Ca':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(calcite_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Ca']['C'].keys():
            self.assertEqual(connectivity_matrix['Ca']['C'][connectivity_type]*calcite_structure.composition['Ca'],
                             ...
                             "Total number of sharing instances between 'Ca' and 'C' should be same as total number of sharing"
    ...
    def test_corundum(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(corundum_structure, False, 2.6, peripheral_species, central_species)
    ...
    def test_hexagonal(self):
        ...
        for cation in CNs:
            ...
            if cation == 'Ba':
                self.assertEqual(round(CNs[cation]), 12, "Ba should be 12-fold coordinated (effective coordination underestimates)")
            if cation == 'Ni':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(hexagonal_structure, False, 3.2, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Ba']['Ni'].keys():
            self.assertEqual(connectivity_matrix['Ba']['Ni'][connectivity_type]*hexagonal_structure.composition['Ba'],
                             ...
                             "Total number of sharing instances between 'Ba' and 'Ni' should be same as total number of sharing"
    ...
    def test_k2nif4(self):
        ...
        for cation in CNs:
            ...
            if cation == 'K':
                self.assertLessEqual(round(CNs[cation]), 9, "Zr should be 9-fold coordinated (effective coordination underestimates)")
            if cation == 'Ni':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(k2nif4_structure, False, 3.0, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['K']['Ni'].keys():
            self.assertEqual(connectivity_matrix['K']['Ni'][connectivity_type]*k2nif4_structure.composition['K'],
                             ...
                             "Total number of sharing instances between 'K' and 'Ni' should be same as total number of sharing"
    ...
    def test_olivine(self):
        ...
        CNs = CN_finder.get_avg_CN(radius=2.6,anions=['O'])
        for cation in CNs:
            self.assertTrue(cation == "Fe" or cation == "Si", "Fe and Si cations should be the only cations in olivine Fe2SiO4")
            if cation == 'Fe':
                self.assertEqual(round(CNs[cation]), 6, "Fe should be 6-fold coordinated")
            if cation == 'Si':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(olivine_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Fe']['Si'].keys():
            self.assertEqual(connectivity_matrix['Fe']['Si'][connectivity_type]*olivine_structure.composition['K'],
                             ...
                             "Total number of sharing instances between 'Fe' and 'Si' should be same as total number of sharing"
    ...
    def test_phenacite(self):
        ...
        CNs = CN_finder.get_avg_CN(radius=2.6,anions=['O'])
        for cation in CNs:
            self.assertTrue(cation == "Be" or cation == "Si", "Be and Si polyanions should be the only ions in phenacite Be2SiO4")
            if cation == 'Be':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(phenacite_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Be']['Si'].keys():
            self.assertEqual(connectivity_matrix['Be']['Si'][connectivity_type]*phenacite_structure.composition['Be'],
                             ...
                             "Total number of sharing instances between 'Be' and 'Si' should be same as total number of sharing"
    ...
    def test_pyroxene(self):
        ...
        for cation in CNs:
            ...
            if cation == 'Mg':
                self.assertLessEqual(round(CNs[cation]), 6, "Mg should be 6-fold coordinated (effective coordination underestimates)")
            if cation == 'Si':
                self.assertEqual(round(CNs[cation]), 4, "Si should be 4-fold coordinated")
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(pyroxene_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Mg']['Si'].keys():
            self.assertEqual(connectivity_matrix['Mg']['Si'][connectivity_type]*pyroxene_structure.composition['Mg'],
                             ...
                             "Total number of sharing instances between 'Mg' and 'Si' should be same as total number of sharing"
    ...
    def test_reo3(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(reo3_structure, False, 2.6, peripheral_species, central_species)
    ...
    def test_rocksalt(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(rocksalt_structure, False, 3.0, peripheral_species, central_species)
    ...
    def test_rutile(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(rutile_structure, False, 2.6, peripheral_species, central_species)
    ...
    def test_scheelite(self):
        ...
        for cation in CNs:
            ...
            if cation == 'Ca':
                self.assertEqual(round(CNs[cation]), 8, "Ca should be 8-fold coordinated (effective coordination underestimates)")
            if cation == 'W':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(scheelite_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Ca']['W'].keys():
            self.assertEqual(connectivity_matrix['Ca']['W'][connectivity_type]*scheelite_structure.composition['Ca'],
                             ...
                             "Total number of sharing instances between 'Ca' and 'W' should be same as total number of sharing"
    ...
    def test_sio2(self):
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(sio2_structure, False, 2.6, peripheral_species, central_species)
    ...
    def test_spinel(self):
        ...
        CNs = CN_finder.get_avg_CN(radius=2.6,anions=['O'])
        for cation in CNs:
            self.assertTrue(cation == "Mg" or cation == "Al", "Mg and Al polyanions should be the only ions in spinel MgAl2O4")
            if cation == 'Mg':
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(spinel_structure, False, 2.6, peripheral_species, central_species)
        self.assertIn('Mg', connectivity_matrix.keys(), "Mg cations not found in matrix")
        ...
        for connectivity_type in connectivity_matrix['Mg']['Al'].keys():
            self.assertEqual(connectivity_matrix['Mg']['Al'][connectivity_type]*spinel_structure.composition['Mg'],
                             ...
                             "Total number of sharing instances between 'Mg' and 'Al' should be same as total number of sharing"
    ...
    def test_perovskite(self):
        ...
        CNs = CN_finder.get_avg_CN(radius=3.2,anions=['O'])
        for cation in CNs:
            self.assertTrue(cation == "Sr" or cation == "Ti", "Be and Si polyanions should be the only ions in phenacite Be2SiO4")
            if cation == 'Sr':
                self.assertLessEqual(round(CNs[cation]), 12, "Sr should be 12-fold coordinated (effective coordination underestimates)")
            if cation == 'Ti':
                self.assertEqual(round(CNs[cation]), 6, "Ti should be 6-fold coordinated")
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(perovskite_structure, False, 3.2, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Sr']['Ti'].keys():
            self.assertEqual(connectivity_matrix['Sr']['Ti'][connectivity_type]*perovskite_structure.composition['Sr'],
                             ...
                             "Total number of sharing instances between 'Sr' and 'Ti' should be same as total number of sharing"
    ...
    def test_zircon(self):
        ...
        CNs = CN_finder.get_avg_CN(radius=2.6,anions=['O'])
        for cation in CNs:
            self.assertTrue(cation == "Zr" or cation == "Si", "Zr and Si polyanions should be the only ions in zircon ZrSiO4")
            if cation == 'Zr':
                self.assertLessEqual(round(CNs[cation]), 8, "Zr should be 8-fold coordinated (effective coordination underestimates)")
            if cation == 'Si':
                self.assertEqual(round(CNs[cation]), 4, "Si should be 4-fold coordinated")
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(zircon_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Zr']['Si'].keys():
            self.assertEqual(connectivity_matrix['Zr']['Si'][connectivity_type]*zircon_structure.composition['Zr'],
                             ...
                             "Total number of sharing instances between 'Zr' and 'Si' should be same as total number of sharing"
    ...
    def test_znso4(self):
        ...
        for cation in CNs:
            ...
            if cation == 'Zn':
                self.assertLessEqual(round(CNs[cation]), 6, "Zn should be 6-fold coordinated (effective coordination underestimates)")
            if cation == 'S':
                self.assertEqual(round(CNs[cation]), 4, "S should be 4-fold coordinated")
        ...
        connectivity_matrix, connectivity_polyhedra = get_connectivity_matrix(znso4_structure, False, 2.6, peripheral_species, central_species)
        ...
        for connectivity_type in connectivity_matrix['Zn']['S'].keys():
            self.assertEqual(connectivity_matrix['Zn']['S'][connectivity_type]*znso4_structure.composition['Zn'],
                             ...
                             "Total number of sharing instances between 'Zn' and 'S' should be same as total number of sharing"
